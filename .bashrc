...
# Auto complete
if command -v az > /dev/null && [[ $(which az) != /mnt/c/* ]]; then source /etc/bash_completion.d/azure-cli; fi
if command -v glab > /dev/null && [[ $(which glab) != /mnt/c/* ]]; then source <(glab completion --shell bash); fi
if command -v kubectl >/dev/null && [[ $(which kubectl) != /mnt/c/* ]]; then
